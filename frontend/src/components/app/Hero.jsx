...
const Hero = () => {
	return (
		<div className='w-full 1000px:flex items-center bg-primary'>
			<div className='absolute top-[100px] 1000px:top-[unset] 1500px:h-[600px] 1500px:w-[600px] 1100px:h-[500px] 1100px:w-[500px] h-[40vh] left-5 w-[40vh] hero_animation rounded-[50%] 1100px:left-8 1500px:left-14 bg-blue-900'></div>
			...
			<div className='1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]'>
				<h2 className='text-primary-foreground text-[30px] px-3 w-full 1000px:text-[50px] font-[600] font-Josefin py-2 1000px:leading-[60px] 1500px:w-[60%] 1100px:w-[78%]'>
