import {
	Trash as AiOutlineDelete,
	CirclePlus as AiOutlinePlusCircle,
	Link as BsLink45Deg,
	PencilLine as BsPencil,
	ChevronDown as MdOutlineKeyboardArrowDown,
} from 'lucide-react'
											...
											<input
												...
												className={`text-[20px] ${
													item.videoSection === 'Untitled Section'
														? 'w-[170px]'
														: 'w-min'
												} border-b border-red-400 font-Poppins cursor-pointer dark:text-white text-black bg-transparent outline-none`}
